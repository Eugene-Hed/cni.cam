...
<div class="slim-sidebar">
    ...
    <div class="slim-nav">
        ...
        <a href="demandes_nationalite.php" class="slim-nav-item <?php echo ($current_page === 'demandes_nationalite.php') ? 'active' : ''; ?>" title="Demandes de nationalité">
            <i class="bi bi-flag"></i>
            <?php if(isset($stats['nouvelles']) && $stats['nouvelles'] > 0): ?>
                <span class="slim-badge"><?php echo $stats['nouvelles']; ?></span>
            <?php endif; ?>
            <span class="slim-tooltip">Demandes de nationalité</span>
        </a>
        
        <a href="profil.php" class="slim-nav-item <?php echo ($current_page === 'profil.php') ? 'active' : ''; ?>" title="Mon profil">
            <i class="bi bi-person"></i>
            <span class="slim-tooltip">Mon profil</span>
        </a>
    </div>
